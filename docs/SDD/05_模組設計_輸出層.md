...
[← 上一章:模組設計 - 處理層](./04_模組設計_處理層.md) | [返回主文件](../System%20Design%20Documentation.md) | [下一章:系統流程 →](./06_系統流程.md)
...
### 5.2.10 前端整合適配器 (Frontend Adapter)
...
class FrontendAdapter:
    ...
    def send_animation_update(self, animation_name: str):
        """通知前端動畫變化"""
        pass
