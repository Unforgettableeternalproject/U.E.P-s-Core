# 第七章:系統流程 (System Workflows)

[← 上一章:展示層架構](./06_展示層架構.md) | [返回主文件](../SDD.md)

---

## 7.1 系統啟動流程 (System Initialization)
...
## 7.3 CHAT 模式完整流程 (CHAT Mode Workflow)
...
## 7.4 WORK 模式完整流程 (WORK Mode Workflow)
...
## 7.5 事件驅動協作 (Event-Driven Collaboration)
...
### 7.5.3 Flow-Based Deduplication 機制
...
## 7.6 Session 生命週期 (Session Lifecycle)
